...
clicking the big arrows between the columns.',
	...
	'smw_wws_s4-intro' => '4. Please provide an alias for each result that is delivered by the Web Service. This alias will be used whenever you include this Web Service. Please use short but distinctive aliases or use the generate function.',
	'smw_wws_s5-intro' => '5. Please define the update policies for this Web Service.',
	'smw_wws_s6-intro' => '6. Please enter a name for this Web Service: ',
	...
	'smw_tsa_addtoconfig3' => 'Also make sure that the wiki URL is a valid one and it does not contain a hash (#). If necessary change enabaleSemantics accordingly, e.g. ',

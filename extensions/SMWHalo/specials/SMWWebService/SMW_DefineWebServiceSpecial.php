...
class SMWDefineWebServiceSpecial extends SpecialPage {
	...
	public function execute() {
		...
		if(!$editwwsd){
			...
			$html .= "<br>";
			$html .= "<div id=\"step1\" class=\"StepDiv\" style=\"display: block\">";
			$html .= "<img id=\"step1-img\" class=\"Marker\" src=\"".$smwgHaloScriptPath."/skins/webservices/pfeil_rechts.gif\" class=\"OKButton\" style=\"visibility: hidden\"></img>";
			$html .= wfMsg("smw_wws_s1-intro");
			$html .= "<input readonly id=\"step1-uri\" type=\"text\" size=\"50\" maxlength=\"300\" value=\"".$wwsd->getURI()."\"/>";
			$html .= "<sup style=\"color: darkred\"><b>*</b></sup>";

			$html .= "<span id=\"step1-go\" class=\"OKButton\">";
			$html .= "<img id=\"step1-go-img\" onclick=\"webServiceSpecial.processStep1()\" src=\"".$smwgHaloScriptPath."/skins/webservices/Control_play.png\" style=\"visibility: hidden\"></img>";
			$html .= "</span>";
			$html .= "<br>";
			$html .= "</div>";
		}
		...
		if(!$editwwsd){
			...
			$html .= "<img class=\"Marker\" id=\"step2-img\" src=\"".$smwgHaloScriptPath."/skins/webservices/pfeil_rechts.gif\" class=\"OKButton\" style=\"visibility: hidden\"></img>";
			$html .= wfMsg("smw_wws_s2-intro");
			$html .= "<select readonly id=\"step2-methods\" size=\"1\">";
			$html .= "<option>".$wwsd->getMethod()."</option>";
			$html .= "</select>";
			$html .= "<span id=\"step2-go\" class=\"OKButton\">";
			$html .= "<img id=\"step2-go-img\" onclick=\"webServiceSpecial.processStep2()\" src=\"".$smwgHaloScriptPath."/skins/webservices/Control_play.png\" style=\"visibility: hidden\"></img>";
			$html .= "</span>";
			$html .= "<br>";
			$html .= "</div>";
		}
		...
		if(!$editwwsd){
			...
			$html .= "<img class=\"Marker\" id=\"step3-img\" src=\"".$smwgHaloScriptPath."/skins/webservices/pfeil_rechts.gif\" class=\"OKButton\" style=\"visibility: hidden\"></img>";
			$html .= wfMsg("smw_wws_s3-intro");
			$html .= "<div id=\"step3-duplicates\" style=\"display:none\"><img src=\"".$smwgHaloScriptPath."/skins/webservices/warning.png\"></img>";
			$html .= wfMsg("smw_wws_duplicate");
			$html .= "</div>";
			...
			$html .= "<span id=\"step3-go\" class=\"OKButton\">";
			$html .= "<img id=\"step3-go-img\" onclick=\"webServiceSpecial.processStep3()\" src=\"".$smwgHaloScriptPath."/skins/webservices/Control_play.png\"  style=\"visibility: hidden\"></img>";
			$html .= "</span>";
			$html .= "</div>";
		}
		...
		if(!$editwwsd){
			...
			$html .= "<img id=\"step4-img\" class=\"Marker\" src=\"".$smwgHaloScriptPath."/skins/webservices/pfeil_rechts.gif\" class=\"OKButton\" style=\"visibility: hidden\"></img>";
			$html .= wfMsg("smw_wws_s4-intro");
			$html .= "<div id=\"step4-duplicates\" style=\"display:none\"><img src=\"".$smwgHaloScriptPath."/skins/webservices/warning.png\"></img>";
			$html .= wfMsg("smw_wws_duplicate");
			$html .= "</div>";
			...
			$html .= "<span id=\"step4-go\" class=\"OKButton\">";
			$html .= "<img id=\"step4-go-img\" onclick=\"webServiceSpecial.processStep4()\" src=\"".$smwgHaloScriptPath."/skins/webservices/Control_play.png\" style=\"visibility: hidden\"></img>";
			$html .= "</span>";
			$html .= "</div>";
		}
		...
		if(!$editwwsd){
			...
			$html .= "<img id=\"step5-img\" class=\"Marker\" src=\"".$smwgHaloScriptPath."/skins/webservices/pfeil_rechts.gif\" class=\"OKButton\" style=\"visibility: hidden\"></img>";
			$html .= wfMsg("smw_wws_s5-intro");
			...
			$html .= "<span id=\"step5-go\" class=\"OKButton\">";
			$html .= "<img id=\"step5-go-img\" onclick=\"webServiceSpecial.processStep5()\" src=\"".$smwgHaloScriptPath."/skins/webservices/Control_play.png\" style=\"visibility: hidden\"></img>";
			$html .= "</span>";
			$html .= "</td></tr></table>";
			$html .= "</div>";
		}
		...
		if(!$editwwsd){
			...
			$html .= "<img id=\"step6-img\" class=\"Marker\" src=\"".$smwgHaloScriptPath."/skins/webservices/pfeil_rechts.gif\" class=\"OKButton\" style=\"visibility: hidden\"></img>";
			$html .= wfMsg("smw_wws_s6-intro");
			$wsName = $wwsd->getName();

 ...
 * @note AUTOLOAD
 */
class AMAskExternal extends SpecialPage {
	...
	public function __construct() {
		parent::__construct('AskExternal');
	...
	protected function makeHTMLResult() {
		global $wgOut;
		$result = '';
		$result_mime = 'text/html'; // output in MW Special page as usual
